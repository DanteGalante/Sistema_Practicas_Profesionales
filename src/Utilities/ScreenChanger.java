...
public class ScreenChanger {
    ...
    private String pantallaGenerarReporteCoordinador = "../Resources/GenerarReporte_Coordinador.fxml";
    ...
    /**
     * Hace el cambio de la pantalla Principal_Coordinador a la pantalla GenerarReporte_Coordinador
     * @param mouseEvent el evento de mouse que inicio el cambio
     * @param errorText el campo de texto donde se coloca un mensaje en caso de error
     */
    public void MostrarPantallaGenerarReporteCoordinador( MouseEvent mouseEvent, Text errorText ) {
        try {
            SetScene(mouseEvent, pantallaGenerarReporteCoordinador);
        } catch (IOException exception) {
            errorText.setText(outputMessages.PantallaGenerarReportePerdido());
            exception.printStackTrace();
        }
    }
